      ...
      <div class="card-content">
        <a-form ref="searchForm" :form="form">
          <a-row>
            ...
            <a-col class="search-item" :span="6">
              <a-form-item label="用户名称" :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }">
                <a-input v-decorator="['nickName']" allow-clear placeholder="请输入用户名称" />
              </a-form-item>
            </a-col>
            <a-col class="search-item" :span="6">
...
export default {
  ...
  beforeRouteLeave (to, from, next) {
    if (to.name === 'exchangeEntityDetail') {
  ...
  methods: {
    ...
    getOrderList () {
      ...
      const params = {
        ...
        cardNumber: data.IC || '',
        startTime:
            (data.createTime && data.createTime.length && data.createTime[0].format('YYYY-MM-DD 00:00:00')) || '',
        endTime:
            (data.createTime && data.createTime.length && data.createTime[1].format('YYYY-MM-DD 23:59:59')) || '',
