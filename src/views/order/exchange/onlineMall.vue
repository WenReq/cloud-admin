  ...
  <div class="onlineMall">
          ...
          <a-row>
            ...
            <a-col class="search-item" :span="6">
              <a-form-item
                ...
                :wrapper-col="{ span: 19 }"
              >
                <a-range-picker v-model="orderDate" class="w100" />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row>
    ...
    <div class="bottomContent">
      ...
      >
        ...
        <template slot="usedEnviron" slot-scope="record">
          <span>{{ record.payType==='2'? record.usedEnviron:record.usedCatCoin }}{{ record.payType | payFl }}</span>
        </template>
        <template slot="giftName" slot-scope="text">
          <span v-if="text" :title="text">{{
...
const columns = [
  ...
  },
  {
    ...
    key: 'usedEnviron',
    dataIndex: '',
    scopedSlots: { customRender: 'usedEnviron' }
  },
  {
    title: '用户昵称',
    key: 'userName',
...
export default {
  ...
  methods: {
    ...
    toExport () {
      ...
      this.toExportExcel(
        '/onLineStore/exportExchangeList',
        params,
        '线上商城兑换数据.xlsx'
      )
    },
