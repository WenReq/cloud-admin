          ...
          <a-row>
            ...
            <a-col class="search-item" :span="6">
              <a-form-item
                ...
                :wrapper-col="{ span: 19 }"
              >
                <a-range-picker v-model="publishDate" class="w100" />
              </a-form-item>
            </a-col>
          </a-row>
          <a-row>
      ...
      >
        <template slot="images" slot-scope="images">
          <img
            ...
            class="cp"
            @click="showPicture((images.length && images[0].path) || '')"
          >
        </template>
        ...
        <template slot="operate" slot-scope="text">
          ...
          <span @click="handle(text)">
            <a-button
              v-if="text.status == '1'" type="link" size="small"
            >发布</a-button>
            <a-button
              v-if="text.status == '2'" type="link" size="small"
            >下线</a-button>
            <a-button
              v-if="text.status == '3'" type="link" size="small"
            >重新发布</a-button>
          </span>
        </template>
      </a-table>
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    if (from.name === 'floorAdvertDetails') {
      next(vm => {
        vm.load()
      })
    } else {
  ...
  methods: {
    ...
    initData () {
      ...
      if (this.publishDate.length !== 0) {
        params.startTime =
          this.publishDate[0].format('YYYY-MM-DD') + ' 00:00:00'
