          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                ...
                allow-clear
                :placeholder="
                  mainTitle === '查看' || mainTitle === '编辑'
                    ? ''
                    : '请填写商户名称，填写后不允许修改请谨慎操作'
                "
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                ...
                allow-clear
                :placeholder="mainTitle === '查看' ? '' : '请填写联系人姓名'"
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              ...
              <a-input
                ...
                allow-clear
                :placeholder="mainTitle === '查看' ? '' : '请填写手机号'"
                ::max-length="11"
              />
            </a-form-item>
          </a-col>
          <a-col class="line-item" :span="12">
            ...
            >
              <div v-if="mainTitle === '查看'" class="commonLine">
                {{ IDNumber }}
                <span
                  v-if="showin && IDNumber"
                  class="showComplete"
                  @click="showAllIDNumber()"
                >完整展示</span>
              </div>
              <a-input
                v-else
                v-decorator="[
                  'IDNumber',
                  { rules: [{ validator: validateIdNo }] }
                ]"
                allow-clear
                :placeholder="mainTitle === '查看' ? '' : '请填写身份证号'"
                ::max-length="18"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                ...
                allow-clear
                :placeholder="mainTitle === '查看' ? '' : '请填写店铺简介'"
                :disabled="disabledValue"
                ::max-length="100"
              />
            </a-form-item>
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                ...
                :placeholder="mainTitle === '查看' ? '' : '请填写商户经营范围'"
                :disabled="disabledValue"
                allow-clear
              />
            </a-form-item>
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-cascader
                ...
                :placeholder="mainTitle === '查看' ? '' : '请选择省市区'"
                :disabled="disabledValue"
                @change="onAreaChange"
              />
            </a-form-item>
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                ...
                allow-clear
                :placeholder="mainTitle === '查看' ? '' : '请填写店铺详细地址'"
                :disabled="disabledValue"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col class="line-item" :span="12">
            ...
            >
              <a-select
                ...
                :placeholder="mainTitle === '查看' ? '' : '请选择客户经理'"
                :disabled="disabledValue"
                allow-clear
                show-search
        ...
        <a-row>
          <a-col class="line-item" :span="12">
            ...
            >
              <a-input
                v-model="remark"
                :placeholder="mainTitle === '查看' ? '' : '请填写备注'"
                ::max-length="50"
                :disabled="disabledValue"
                allow-clear
              />
            ...
            >
              <div>
                ...
                >
                  <div
                    v-if="
                      credentialsFileList.length < 2 && mainTitle !== '查看'
                    "
                  >
                    <a-icon type="plus" />
                    <div>
                  ...
                  <div
                    v-if="
                      credentialsFileList.length === 0 && mainTitle === '查看'
                    "
                  ></div>
                </a-upload>
                <div
                  v-if="mainTitle === '添加' || mainTitle === '编辑'"
                  class="photoWarn"
                >
                  <a-icon type="exclamation-circle" />
                  证件照片最多可以上传2张，正反面各1张，每张大小不超过10M，格式为png，jpeg，jpg。
                </div>
                <a-modal
                  :visible="credentialsVisible"
                  :footer="null"
                  @cancel="handleCredentialsCancel"
                >
            ...
            >
              <div>
                ...
                >
                  ...
                  <div
                    v-if="shopFileList.length === 0 && mainTitle === '查看'"
                  ></div>
                </a-upload>
                <div
                  v-if="mainTitle === '添加' || mainTitle === '编辑'"
                ...
                >
                  <a-icon type="exclamation-circle" />
                  店铺照片每张大小不超过10M，最多可以上传3张，格式为png，jpeg，jpg，第一张默认为主图。
                </div>
                <a-modal
                  :visible="shopVisible"
                  :footer="null"
                  @cancel="handleShopCancel"
                >
            ...
            >
              <div>
                ...
                >
                  <div
                    v-if="
                      qualificationFileList.length < 3 && mainTitle !== '查看'
                    "
                  >
                    <a-icon type="plus" />
                    <div>
                  ...
                  <div
                    v-if="
                      qualificationFileList.length === 0 && mainTitle === '查看'
                    "
                  ></div>
                </a-upload>
                <div
                ...
                >
                  <a-icon type="exclamation-circle" />
                  上传营业执照、组织机构代码证、税务登记证扫描件或照片，每张大小不超过10M，最多可以上传3张，格式为png，jpeg，jpg。
                </div>
                <a-modal
                  :visible="qualificationVisible"
                  :footer="null"
                  @cancel="handleQualificationCancel"
                >
          ...
          <a-col class="line-item mt16" :span="24">
            ...
            >
              <div>
                ...
                >
                  <div
                    v-if="contractFileList.length < 6 && mainTitle !== '查看'"
                  >
                    <a-icon type="plus" />
                    <div>
                      上传图片
                  ...
                  <div
                    v-if="contractFileList.length === 0 && mainTitle === '查看'"
                  ></div>
                </a-upload>
                <div
                  v-if="mainTitle === '添加' || mainTitle === '编辑'"
                ...
                >
                  <a-icon type="exclamation-circle" />
                  上传合同扫描件或照片，每张大小不超过10M，最多可以上传6张，格式为png，jpeg，jpg。
                </div>
                <a-modal
    ...
    >
      <div class="dlContent">
        ...
        <a-form :form="exportForm" class="mt16">
          <a-form-item>
            <a-range-picker
              v-decorator="['exportDate', rangeConfig]"
              format="YYYY-MM-DD"
            />
          </a-form-item>
        </a-form>
...
export default {
  ...
  mixins: [toExportExcel, iconFontComponent],
  data () {
    return {
      mainTitle: '',
      ...
      getMerchantInfo(params).then(res => {
        ...
        setTimeout(() => {
          this.form.setFieldsValue({
            area: [
              res.result.info.provinceId,
              res.result.info.cityId,
              res.result.info.areaId
            ]
          })
        }, 500)
        this.form.setFieldsValue({
        ...
        this.areaLabel = [
          res.result.info.provinceName,
          res.result.info.cityName,
          res.result.info.areaName
        ]
      })
    },
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          if (this.areaLabel.length !== 0) {
            ...
            if (this.areaLabel[2]) {
              params.areaName = this.areaLabel[2]
            }
          }
