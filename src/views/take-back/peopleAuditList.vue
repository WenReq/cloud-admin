...
export default {
  ...
  mounted () {
    ...
    const params = {}
    params.startTime = this.auditDate[0].format('YYYY-MM-DD 00:00:00')
    params.endTime = this.auditDate[1].format('YYYY-MM-DD 23:59:59')
  ...
  methods: {
    ...
    initData () {
      ...
      if (this.auditTime.length !== 0) {
        params.startTime = this.auditTime[0].format('YYYY-MM-DD 00:00:00')
        params.endTime = this.auditTime[1].format('YYYY-MM-DD 23:59:59')
      }
