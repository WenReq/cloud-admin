...
// 账号配置-角色查询菜单
export function roleFindMenu (data) {
  return httpPost('/cloud/cus/user/getMenuListByRole', data)
}
...
// 卡号查询
export function cardNum (cardNumber) {
  const data = {
    cardNumber
  }
  return httpPost('/cloud/cus/user/getCardNum', data)
}

// 小程序配置查询
export function getApplet () {
  return httpPost('/cloud/cus/extend/getExtendInfo')
}

// 小程序配置添加和修改
export function upDateApplet (data) {
  return httpPost('/cloud/cus/extend/editExtend', data)
}
