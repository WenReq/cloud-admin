...
// 日志
export function indexPageUserInfo (data = {}) {
...
//  管理工作人员概况
export function staffProfile (data = {}) {
  return httpPost('indexPage/getStaffProfile', data)
}

// 今日投递数据
export function todayData (data = {}) {
  return httpPost('indexPage/todayData', data)
}
